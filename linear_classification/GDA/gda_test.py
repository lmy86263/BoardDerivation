...
def plot_decision_regions(X, y, classifiers: list, label: list, test_idx=None, resolution=0.02):
    ...
    for idx, classifier, tt in zip(range(num_of_plots), classifiers, label):
...
if __name__ == '__main__':
    ...
    plot_decision_regions(X=X_combined_std,
                          y=y_combined_std,
                          classifiers=[gda], label=['self-handwritten'],
